...
<div class="hero-area overlay" style="background-image: url({{asset('assets/images/'.$gs->bgimg)}});">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="donors-header text-center">{{$lang->fht}}</h1>
                        <div class="hero-form">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="team_common">
                            <div class="member_img">
                                <a href="{{route('front.user',$user->id)}}"><img src="{{ $user->photo ? asset('assets/images/'.$user->photo):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="member image"></a>
                            </div>
                            <div class="member_info text-center pos_relative">
                                ...
                                <div class="content">
                                    ...
                                    <ul class="social_contact pt_10" style="padding-left: 0px;">
                                        ...
                                        @if($user->g_url != null)
                                        <li>
                                        <a href="{{$user->g_url ? $user->g_url:'https://www.instagram.com/'}}" title="Instagram" target="_blank"><i class="fa fa-instagram"></i></a>
                                        </li>
                                        @endif
                                    </ul>
                                </div>

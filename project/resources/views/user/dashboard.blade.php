                                ...
                                @else
                                    <div class="profile-description-box margin-bottom-30 text-center">
                                        <button class="boxed-btn blog" type="button" data-toggle="modal"
                                                data-target="#ModalAll" style="width: 160px;">{{$lang->ppr}}</button>
                                    </div>
                                @endif
                            @endif
                        @endif
                    ...
                    @elseif($user->is_featured != 1)
                        @if($user->featured != 1)
                            ...
                            @else
                                ...
                                <div class="profile-description-box margin-bottom-30 text-center">
                                    <button class="boxed-btn blog" type="button" data-toggle="modal"
                                            data-target="#ModalFeature" style="width: 160px;">{{$lang->fpr}}</button>
                                </div>
                            @endif
                        @endif
                    @endif
                            ...
                            <div class="table-responsive" style="overflow: hidden;">
                                ...
                                <ul class="row">
                                    @foreach($categories as $category)
                                        <li class="col-md-6 col-sm-6">{{\app\User::getCategoryName($category)}}</li>
                                    @endforeach
                                </ul>

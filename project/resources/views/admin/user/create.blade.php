                                ...
                                <div class="add-product-box">
                                    ...
                                    <form class="form-horizontal" action="{{route('admin-user-store')}}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="name" id="full_name"
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="profile_photo">Add Photo
                                                *</label>
                                            <div class="col-sm-6">
                                                <input type="file" id="uploadFile" class="hidden" name="photo" value="">
                                                <button type="button" id="uploadTrigger" onclick="uploadclick()"
                                                        class="form-control"><i class="fa fa-download"></i> Add Profile
                                                    Photo
                                                </button>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="profile_description">Profile
                                                Description*</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="fax" id="fax" placeholder="Enter Fax"
                                                       type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="add-product-footer">
                                            <button name="addProduct_btn" id="submit" type="submit" id="hak_user_submit_btn"
                                                    class="btn add-product_btn">Add Doctor
                                            </button>
                                        </div>
                                    </form>
                                </div>
